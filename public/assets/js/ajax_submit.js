...
function ajax_submit_createbast(route, id) {
    $("#modal_data").empty();
    $('.modal-title').text('Add New'); // Set Title to Bootstrap modal title

    $.ajax({
        type: 'GET',
        url: route + '/createbast',
        success: function (data) {
            $("#modal_data").html(data.html);
            $('#myModal').modal('show'); 
        },
...
function ajax_submit_cetakpdf(route, id) {

    $.ajax({
        url: route + '/' + id + '/cetakpdf',
        type: 'get',
        success: function (data) {
            console.log(data)
        },
...
function ajax_submit_updatemodule(route, id_module) {
