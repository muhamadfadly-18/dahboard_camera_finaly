<form id='create' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="needs-validation" novalidate>
    ...
    <div class="form-row">
        <div class="form-group col-md-2 col-sm-12">
            ...
            <input type="text" class="form-control" id="worker_id" name="worker_id" value=""
                   placeholder="" required>
            <span id="error_worker_id" class="has-error"></span>
        </div>
        <div class="form-group col-md-2 col-sm-12">
            <label for=""> Event Scene ID </label>
            <input type="text" class="form-control" id="event_scene_id" name="event_scene_id" value=""
                   placeholder="" required>
            <span id="error_event_scene_id" class="has-error"></span>
        </div>
        <div class="form-group col-md-2 col-sm-12">
            <label for=""> Activity ID </label>
            <input type="text" class="form-control" id="activity_id" name="activity_id" value=""
                   placeholder="" required>
...
<script>
    $('.button-submit').click(function () {
        // route name
        ajax_submit_store('eventworkers')
    });
</script>
